...
VALUES (1, 'test@mail.ru', '$2a$10$Tkb2wARs/N4RJ3nHPrOuSOImwKxP7eSM2xXf5q4k1scWfjqIyhFNa', 'test') ON CONFLICT DO NOTHING;
...
VALUES
    ...
    (5, 'Требуется эксперт по искусственному интеллекту', 'Наш стартап ищет эксперта по искусственному интеллекту для создания образовательных решений с использованием новейших технологий. Опыт в области машинного обучения приветствуется.', 1) ON CONFLICT DO NOTHING;;
...
VALUES
    ...
    (5, 'Партнерство с ведущими университетами', 'Мы гордимся объявить о партнерстве с ведущими университетами. Совместные проекты и программы помогут студентам и профессионалам расширить свои знания и навыки.', '2024-03-28') ON CONFLICT DO NOTHING;;
